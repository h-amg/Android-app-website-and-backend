    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(
            ...
            if user.admin:
                ...
                return render_template('user/nutritionist.html', userEmail=user.email)
        else:
...
@user_blueprint.route('/nutritionist-dashboard')
@login_required
def nutritionist_dasahboard():
    """Displays nutritionist's dashboard"""
    return render_template('user/nutritionist.html')
