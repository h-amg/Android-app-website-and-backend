!function() {
	...
	i.classList.contains("has-animations")&&window.addEventListener("load", function() {
		n.reveal(".feature-extended .device-mockup", {
			duration: 600, distance:"100px", easing:"cubic-bezier(0.215, 0.61, 0.355, 1)", origin:"bottom", viewFactor:.6
		}
		), n.reveal(".feature-extended .feature-extended-body", {
			duration: 600, distance:"40px", easing:"cubic-bezier(0.215, 0.61, 0.355, 1)", origin:"top", viewFactor:.6
		}
		)
	}
	);
	...
	a.prototype.generateBubbles=function() {
		...
		for(let e=0;
		e<t.bubbleDensity();
		e++)t.addBubble(new s(t.canvas.parentNode))
	}
	,
