...
$.post( "/twilio_token", 
  JSON.stringify({'identity': userEmail, 'video': true})
  , function(err, req, resp) {
  identity = userEmail;
  /*console.log(userEmail);*/
  /*console.log(resp.responseJSON.token);*/
  ...
  document.getElementById('button-join').onclick = function() {
    ...
    Video.connect(resp.responseJSON.token, connectOptions).then(roomJoined, function(error) {
